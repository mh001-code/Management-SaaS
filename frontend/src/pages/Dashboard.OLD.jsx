...
const Dashboard = () => {
  ...
  return (
    <div className="main-content">
      <div className="topbar">
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "var(--text-sm)", margin: 0, marginTop: "var(--space-xs)" }}>
            Resumo de operações e desempenho
          </p>
        </div>
      ...
      <div className="page-body" style={{ paddingTop: "var(--space-2xl)" }}>
        {loading ? (
          ...
          <>
            ...
            <div style={{ marginBottom: "var(--space-3xl)" }}>
              ...
              <div className="stat-grid">
                {STAT_CARDS.map((card) => (
                  <div key={card.label} className={`stat-card animate-fadeUp ${card.delay}`}>
            ...
            <div>
              ...
              <div className="charts-grid">
                <div className="chart-card animate-fadeUp fade-up-1" style={{ minHeight: "300px" }}>
                ...
                <div className="chart-card animate-fadeUp fade-up-2" style={{ minHeight: "300px" }}>
              ...
              <div className="chart-card animate-fadeUp fade-up-3" style={{ marginTop: "var(--space-lg)", minHeight: "300px" }}>
